...
const Hero = () => {
  return (
    <div className='relative w-full rounded-xl -z-10'>
      ...
      <div className='absolute flex flex-col max-w-[600px] rounded-xl bg-white p-10 bottom-[-50px] shadow-md left-16 md:w-[450px] sm:w-[350px] sm:relative sm:top-[-80px] sm:left-5 sm:p-7'>
