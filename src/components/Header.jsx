  ...
  return (
    <div className="h-[100px]">
      <div className="flex justify-between items-center py-8 px-5 sm:py-5 sm:border border-gray-200">
        ...
        <nav className="px-[116px] sm:hidden">
        ...
        <div className="flex items-center gap-10 sm:gap-3">
            <div className="relative">
                <input type="text" className="w-[166px] bg-[#F4F4F5] rounded-md pl-[10px] pr-[30px] py-2 sm:hidden" placeholder="Search"/>
        ...
        <nav className={`${openMenu ? 'w-full' : 'w-0 overflow-x-hidden'} lg:hidden absolute right-0 top-[77px] transition-all duration-300 bg-gray-100/80 backdrop-blur-sm`}>
      ...
      <div className="lg:hidden px-5">
         <input type="text" className={`${search ? 'animate__slideInDown block' : 'hidden'} animate__animated transition-all w-full bg-[#F4F4F5] z-10 rounded-md pl-[10px] pr-[30px] py-2 animate__animated`} placeholder="Search"/>
      </div>
    </div>
  );
};
